...
VALUES
    -- 管理员
    (1, 'admin', '$2a$10$N9qo8uLOickgx2ZMRZoMye.IKN/6v3.1.7', '系统管理员', '13800000001', 'admin@hospital.com', 'ADMIN', NULL, NULL, 1, 'https://avatar.example.com/admin.jpg', '系统管理员账号'),

    -- 医生用户
    (2, 'doctor001', '$2a$10$N9qo8uLOickgx2ZMRZoMye.IKN/6v3.1.7', '张伟', '13800001001', 'doctor001@hospital.com', 'DOCTOR', 1, 1, 1, 'https://avatar.example.com/doctor001.jpg', '内科医生'),
    (3, 'doctor002', '$2a$10$N9qo8uLOickgx2ZMRZoMye.IKN/6v3.1.7', '李娜', '13800001002', 'doctor002@hospital.com', 'DOCTOR', 1, 2, 1, 'https://avatar.example.com/doctor002.jpg', '内科医生'),
    (4, 'doctor003', '$2a$10$N9qo8uLOickgx2ZMRZoMye.IKN/6v3.1.7', '王强', '13800001003', 'doctor003@hospital.com', 'DOCTOR', 1, 3, 1, 'https://avatar.example.com/doctor003.jpg', '内科医生'),
    (5, 'doctor004', '$2a$10$N9qo8uLOickgx2ZMRZoMye.IKN/6v3.1.7', '刘洋', '13800002001', 'doctor004@hospital.com', 'DOCTOR', 2, 4, 1, 'https://avatar.example.com/doctor004.jpg', '外科医生'),
    (6, 'doctor005', '$2a$10$N9qo8uLOickgx2ZMRZoMye.IKN/6v3.1.7', '陈静', '13800002002', 'doctor005@hospital.com', 'DOCTOR', 2, 5, 1, 'https://avatar.example.com/doctor005.jpg', '外科医生'),
    (7, 'doctor006', '$2a$10$N9qo8uLOickgx2ZMRZoMye.IKN/6v3.1.7', '杨敏', '13800003001', 'doctor006@hospital.com', 'DOCTOR', 3, 6, 1, 'https://avatar.example.com/doctor006.jpg', '儿科医生'),
    (8, 'doctor007', '$2a$10$N9qo8uLOickgx2ZMRZoMye.IKN/6v3.1.7', '赵杰', '13800003002', 'doctor007@hospital.com', 'DOCTOR', 3, 7, 1, 'https://avatar.example.com/doctor007.jpg', '儿科医生'),
    (9, 'doctor008', '$2a$10$N9qo8uLOickgx2ZMRZoMye.IKN/6v3.1.7', '周婷', '13800004001', 'doctor008@hospital.com', 'DOCTOR', 4, 8, 1, 'https://avatar.example.com/doctor008.jpg', '妇产科医生'),
    (10, 'doctor009', '$2a$10$N9qo8uLOickgx2ZMRZoMye.IKN/6v3.1.7', '吴磊', '13800004002', 'doctor009@hospital.com', 'DOCTOR', 4, 9, 1, 'https://avatar.example.com/doctor009.jpg', '妇科医生'),
    (11, 'doctor010', '$2a$10$N9qo8uLOickgx2ZMRZoMye.IKN/6v3.1.7', '郑浩', '13800005001', 'doctor010@hospital.com', 'DOCTOR', 5, 10, 1, 'https://avatar.example.com/doctor010.jpg', '眼科医生'),
    (12, 'doctor011', '$2a$10$N9qo8uLOickgx2ZMRZoMye.IKN/6v3.1.7', '孙丽', '13800006001', 'doctor011@hospital.com', 'DOCTOR', 6, 11, 1, 'https://avatar.example.com/doctor011.jpg', '耳鼻喉科医生'),
    (13, 'doctor012', '$2a$10$N9qo8uLOickgx2ZMRZoMye.IKN/6v3.1.7', '钱勇', '13800007001', 'doctor012@hospital.com', 'DOCTOR', 7, 12, 1, 'https://avatar.example.com/doctor012.jpg', '急诊内科医生'),
    (14, 'doctor013', '$2a$10$N9qo8uLOickgx2ZMRZoMye.IKN/6v3.1.7', '何娟', '13800007002', 'doctor013@hospital.com', 'DOCTOR', 7, 13, 1, 'https://avatar.example.com/doctor013.jpg', '急诊外科医生'),

    -- 护士用户
    (15, 'nurse001', '$2a$10$N9qo8uLOickgx2ZMRZoMye.IKN/6v3.1.7', '护士长王芳', '13800000101', 'nurse001@hospital.com', 'NURSE', 1, NULL, 1, 'https://avatar.example.com/nurse001.jpg', '护士长'),
    (16, 'nurse002', '$2a$10$N9qo8uLOickgx2ZMRZoMye.IKN/6v3.1.7', '护士李丽', '13800000102', 'nurse002@hospital.com', 'NURSE', 1, NULL, 1, 'https://avatar.example.com/nurse002.jpg', '值班护士'),

    -- 药师用户
    (17, 'pharmacist001', '$2a$10$N9qo8uLOickgx2ZMRZoMye.IKN/6v3.1.7', '主任药师赵敏', '13800000201', 'pharmacist001@hospital.com', 'PHARMACIST', NULL, NULL, 1, 'https://avatar.example.com/pharmacist001.jpg', '药房主任'),

    -- 收费员用户
    (18, 'cashier001', '$2a$10$N9qo8uLOickgx2ZMRZoMye.IKN/6v3.1.7', '收费员孙磊', '13800000301', 'cashier001@hospital.com', 'CASHIER', NULL, NULL, 1, 'https://avatar.example.com/cashier001.jpg', '收费员');
